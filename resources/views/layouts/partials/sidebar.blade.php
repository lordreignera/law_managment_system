@php
    $items = [
        ['label' => 'Dashboard', 'icon' => 'mdi-view-dashboard', 'route' => 'dashboard', 'permission' => 'view dashboard'],
        [
            ...
            'children' => [
                ['label' => 'Client Intakes', 'route' => 'intakes.index', 'active' => 'intakes.*', 'permission' => 'manage intakes'],
                ['label' => 'Approved Clients', 'route' => 'clients.index', 'active' => 'clients.*', 'permission' => 'manage clients'],
            ],
            'permission_any' => ['manage intakes', 'manage clients'],
        ],
        [
            ...
            'permission' => 'manage matters',
        ],
        ['label' => 'Recoveries', 'icon' => 'mdi-bank', 'route' => 'recoveries.index', 'permission' => 'manage recoveries'],
        ['label' => 'Land Titles', 'icon' => 'mdi-file-document', 'route' => 'land-titles.index', 'permission' => 'manage land titles'],
        ['label' => 'Finance', 'icon' => 'mdi-cash-multiple', 'route' => 'finance.index', 'permission' => 'manage finance'],
        ['label' => 'Staff', 'icon' => 'mdi-account-multiple', 'route' => 'staff.index', 'permission' => 'manage staff'],
        [
            ...
            'active' => 'access.*',
            'children' => [
                ['label' => 'All Users', 'route' => 'access.users.index'],
                ['label' => 'Approval Requests', 'route' => 'access.approvals.index'],
                ['label' => 'Roles', 'route' => 'access.roles.index'],
                ['label' => 'Permissions', 'route' => 'access.permissions.index'],
            ],
            'permission' => 'manage access control',
        ],
        ['label' => 'System Settings', 'icon' => 'mdi-tune', 'route' => 'settings.system.overview', 'active' => 'settings.system.*', 'permission' => 'manage settings'],
        ['label' => 'Company Settings', 'icon' => 'mdi-settings', 'route' => 'settings.company.edit', 'active' => 'settings.company.*', 'permission' => 'manage settings'],
    ];
@endphp
